...
// https://api.twitter.com/1.1/statuses/home_timeline.json
    ...
    public ValidatableResponse createTweet(String tweet){   // Always we have to follow the documentation that will tell us what type of method we need to use
        return  access.param("status",tweet).when().post(this.baseUrl+CREATE_TWEET_ENDPOINT).then();    //(EX: GET or POST)
    }
